...
class Triangle extends Logo {
  ...
  render() {
    ...
    <text x="150" y="150" text-anchor="middle" font-size="90" fill="${this.textColor}">${this.text}</text>
  </svg>`;
  }
}
...
class Square extends Logo {
  ...
  render() {
    ...
    <text x="195" y="150" text-anchor="middle" font-size="90" fill="${this.textColor}">${this.text}</text>
  </svg>`;
  }
}
